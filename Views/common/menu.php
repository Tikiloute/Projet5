<nav class="navbar navbar-expand-lg rounded navbar-light bg-light me-5">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <li class="nav-item d-flex align-items-center me-3"><button class="btn btn-dark bouton">Mode nuit</button></li>
